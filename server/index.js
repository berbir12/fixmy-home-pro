  ...
  try {
    const services = [
      // Computer & Tech Services
      {
        ...
        name: 'Computer Diagnostics & Repair',
        description: 'Comprehensive computer diagnostics and repair services for all major brands',
        icon: 'Monitor',
        price: 89.99,
        duration: '60 minutes',
        category: 'Computer Services',
        features: ['Virus Removal', 'Hardware Diagnostics', 'Software Installation', 'Data Recovery'],
      },
      {
        id: 'laptop-repair',
        name: 'Laptop Repair & Maintenance',
        description: 'Professional laptop repair and maintenance services for all brands',
        icon: 'Laptop',
        price: 119.99,
        duration: '75 minutes',
        category: 'Computer Services',
        features: ['Screen Replacement', 'Keyboard Repair', 'Battery Replacement', 'Performance Optimization'],
      },
      {
        id: 'gaming-pc-build',
        name: 'Gaming PC Build & Setup',
        description: 'Custom gaming PC assembly and optimization services',
        icon: 'Gamepad2',
        price: 199.99,
        duration: '150 minutes',
        category: 'Computer Services',
        features: ['PC Assembly', 'OS Installation', 'Driver Setup', 'Performance Tuning'],
      },
      {
        id: 'software-installation',
        name: 'Software Installation & Training',
        description: 'Professional software installation and user training services',
        icon: 'Download',
        price: 79.99,
        duration: '60 minutes',
        category: 'Computer Services',
        features: ['Software Installation', 'User Training', 'Data Migration', 'Support Setup'],
      },
      ...
      // Network Services
      {
        ...
        features: ['WiFi Setup', 'Router Configuration', 'Network Security', 'Device Connection'],
      },
      {
        id: 'wifi-optimization',
        name: 'WiFi Network Optimization',
        description: 'Professional WiFi network optimization and troubleshooting',
        icon: 'Signal',
        price: 89.99,
        duration: '60 minutes',
        category: 'Network Services',
        features: ['Signal Analysis', 'Router Optimization', 'Dead Zone Elimination', 'Speed Testing'],
      },
      {
        id: 'server-setup',
        ...
        category: 'Network Services',
        features: ['Server Installation', 'OS Configuration', 'Security Setup', 'Backup Configuration'],
      },
      ...
      // Smart Home Services
      {
        ...
        description: 'Complete smart home installation and configuration services',
        icon: 'Home',
        price: 199.99,
        duration: '120 minutes',
        category: 'Smart Home',
        features: ['Smart Speaker Setup', 'Security Camera Installation', 'Smart Thermostat', 'Lighting Control'],
      },
      {
        id: 'iot-integration',
        name: 'IoT Device Integration',
        description: 'Professional IoT device integration and automation services',
        icon: 'Zap',
        price: 159.99,
        duration: '90 minutes',
        category: 'Smart Home',
        features: ['Device Setup', 'Network Integration', 'Automation Configuration', 'Training'],
      },
      {
        id: 'smart-office-setup',
        name: 'Smart Office Setup',
        description: 'Complete smart office automation and configuration',
        icon: 'Building',
        price: 399.99,
        duration: '240 minutes',
        category: 'Smart Home',
        features: ['Automation Setup', 'Device Integration', 'Workflow Optimization', 'Training'],
      },
      ...
      // Security Services
      {
        ...
        description: 'Complete security camera system installation and setup',
        icon: 'Camera',
        price: 249.99,
        duration: '120 minutes',
        category: 'Security Services',
        features: ['Camera Installation', 'DVR Setup', 'Mobile App Configuration', 'Remote Monitoring'],
      },
      {
        id: 'cybersecurity-assessment',
        name: 'Cybersecurity Assessment',
        description: 'Professional cybersecurity assessment and protection setup',
        icon: 'Shield',
        price: 299.99,
        duration: '180 minutes',
        category: 'Security Services',
        features: ['Security Audit', 'Vulnerability Assessment', 'Protection Setup', 'Training'],
      },
      ...
      // Web & Digital Services
      {
        ...
        features: ['Website Design', 'Domain Setup', 'Hosting Configuration', 'SEO Optimization'],
      },
      {
        id: 'ecommerce-setup',
        name: 'E-commerce Platform Setup',
        description: 'Professional e-commerce website setup and configuration',
        icon: 'ShoppingCart',
        price: 299.99,
        duration: '180 minutes',
        category: 'Web Services',
        features: ['Platform Setup', 'Payment Integration', 'Inventory Management', 'Security Setup'],
      },
      {
        id: 'digital-marketing-setup',
        name: 'Digital Marketing Setup',
        description: 'Professional digital marketing platform setup and optimization',
        icon: 'TrendingUp',
        price: 149.99,
        duration: '90 minutes',
        category: 'Marketing Services',
        features: ['Social Media Setup', 'Analytics Configuration', 'Ad Platform Setup', 'Content Strategy'],
      },
      ...
      // Creative Services
      {
        ...
        description: 'Professional video editing workstation setup and training',
        icon: 'Video',
        price: 159.99,
        duration: '120 minutes',
        category: 'Creative Services',
        features: ['Hardware Setup', 'Software Installation', 'Workflow Training', 'Optimization'],
      },
      {
        id: 'audio-recording-setup',
        name: 'Audio Recording Setup',
        description: 'Professional audio recording equipment setup and configuration',
        icon: 'Mic',
        price: 129.99,
        duration: '90 minutes',
        category: 'Creative Services',
        features: ['Equipment Setup', 'Software Configuration', 'Acoustic Treatment', 'Training'],
      },
      {
        id: 'podcast-studio-setup',
        name: 'Podcast Studio Setup',
        description: 'Professional podcast recording studio setup and configuration',
        icon: 'Radio',
        price: 199.99,
        duration: '120 minutes',
        category: 'Creative Services',
      ...
      },
      {
        ...
        description: 'Professional live streaming equipment setup and configuration',
        icon: 'Broadcast',
        price: 179.99,
        duration: '90 minutes',
        category: 'Creative Services',
        features: ['Equipment Setup', 'Platform Configuration', 'Stream Optimization', 'Training'],
      },
      {
        id: 'photography-workstation',
        name: 'Photography Workstation',
        description: 'Professional photography editing workstation setup',
        icon: 'Camera',
        price: 189.99,
        duration: '120 minutes',
        category: 'Creative Services',
        features: ['Hardware Setup', 'Software Installation', 'Color Calibration', 'Training'],
      },
      {
        id: 'digital-art-setup',
        name: 'Digital Art Setup',
        description: 'Professional digital art workstation setup and training',
        icon: 'Palette',
        price: 139.99,
        duration: '90 minutes',
        category: 'Creative Services',
        features: ['Hardware Setup', 'Software Installation', 'Training', 'Workflow Optimization'],
      },
      ...
      // Entertainment Services
      {
        ...
        description: 'Professional home theater system installation and calibration',
        icon: 'Tv',
        price: 179.99,
        duration: '90 minutes',
        category: 'Entertainment',
        features: ['Speaker Installation', 'Receiver Setup', 'Video Calibration', 'Remote Programming'],
      },
      {
        id: 'vr-setup',
        name: 'Virtual Reality Setup',
        description: 'Professional VR system installation and configuration',
        icon: 'Glasses',
        price: 199.99,
        duration: '120 minutes',
        category: 'Entertainment',
        features: ['VR Setup', 'Room Configuration', 'Software Installation', 'Training'],
      },
      ...
      // Mobile Services
      {
        ...
        features: ['Screen Replacement', 'Battery Replacement', 'Water Damage Repair', 'Data Recovery'],
      },
      ...
      // Data Services
      {
        ...
        description: 'Secure data backup solutions and data recovery services',
        icon: 'Database',
        price: 129.99,
        duration: '90 minutes',
        category: 'Data Services',
        features: ['Cloud Backup Setup', 'Local Backup', 'Data Recovery', 'Security Setup'],
      },
      {
        id: 'cloud-storage-setup',
        name: 'Cloud Storage Setup',
        description: 'Professional cloud storage configuration and migration services',
        icon: 'Cloud',
        price: 69.99,
        duration: '45 minutes',
        category: 'Data Services',
        features: ['Cloud Setup', 'Data Migration', 'Security Configuration', 'Backup Setup'],
      },
      ...
      // Office Equipment
      {
        ...
        description: 'Professional printer installation, configuration, and troubleshooting',
        icon: 'Printer',
        price: 69.99,
        duration: '45 minutes',
        category: 'Office Equipment',
        features: ['Printer Installation', 'Driver Setup', 'Network Configuration', 'Troubleshooting'],
      },
      
      // Engineering Services
      {
        id: 'cad-workstation-setup',
        name: 'CAD Workstation Setup',
        description: 'Professional CAD workstation setup and optimization',
        icon: 'Ruler',
        price: 249.99,
        duration: '150 minutes',
        category: 'Engineering',
        features: ['Hardware Setup', 'Software Installation', 'Performance Optimization', 'Training'],
      },
      
      // Communication Services
      {
        id: 'video-conferencing-setup',
        name: 'Video Conferencing Setup',
        description: 'Professional video conferencing system setup and optimization',
        icon: 'Phone',
        price: 129.99,
        duration: '60 minutes',
        category: 'Communication',
        features: ['Equipment Setup', 'Platform Configuration', 'Network Optimization', 'Training'],
      },
      
      // Specialized Services
      {
        id: 'drone-setup-training',
        name: 'Drone Setup & Training',
        description: 'Professional drone setup, configuration, and pilot training',
        icon: 'Drone',
        price: 249.99,
        duration: '150 minutes',
        category: 'Aerial Services',
        features: ['Drone Assembly', 'Controller Setup', 'Flight Training', 'Safety Training'],
      },
      {
        id: '3d-printing-setup',
        name: '3D Printing Setup',
        description: 'Professional 3D printer setup and configuration services',
        icon: 'Cube',
        price: 179.99,
        duration: '120 minutes',
        category: 'Manufacturing',
        features: ['Printer Assembly', 'Software Setup', 'Calibration', 'Training'],
      },
      {
        id: 'smart-retail-setup',
        name: 'Smart Retail Setup',
        description: 'Complete smart retail system setup and configuration',
        icon: 'Store',
        price: 499.99,
        duration: '300 minutes',
        category: 'Retail Services',
        features: ['POS Setup', 'Inventory System', 'Security Integration', 'Training'],
      },
      {
        id: 'fitness-tech-setup',
        name: 'Fitness Tech Setup',
        description: 'Professional fitness technology setup and configuration',
        icon: 'Activity',
        price: 159.99,
        duration: '90 minutes',
        category: 'Health Services',
        features: ['Equipment Setup', 'App Configuration', 'Data Integration', 'Training'],
      },
      {
        id: 'educational-tech-setup',
        name: 'Educational Tech Setup',
        description: 'Professional educational technology setup and training',
        icon: 'GraduationCap',
        price: 199.99,
        duration: '120 minutes',
        category: 'Education Services',
        features: ['Equipment Setup', 'Software Installation', 'Training', 'Support Setup'],
      },
