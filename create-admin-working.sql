-- WORKING ADMIN CREATION SCRIPT
-- This script creates an admin user that will definitely work
...
INSERT INTO auth.users (
    ...
    gen_random_uuid(),
    'admin@fixmyhomepro.com', -- CHANGE THIS TO YOUR EMAIL
...
BEGIN
    -- Get the user ID
    SELECT id INTO user_id FROM auth.users WHERE email = 'admin@fixmyhomepro.com'; -- CHANGE THIS TO YOUR EMAIL
